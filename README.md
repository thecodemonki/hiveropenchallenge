...
Generate a synthetic support-email dataset.

Retrieve similar past tickets with TF-IDF.

Draft a reply with Claude using few-shot examples.

Score the draft against the held-out reference reply.

Show the results in a Streamlit dashboard.
